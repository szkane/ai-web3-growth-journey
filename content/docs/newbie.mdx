...
2、 下载多层级、不同稀有度、不同特征的NFT材料，[立即下载](https://pan.quark.cn/s/76e84633ae36)。
...
8、由于这里我想要实现多层级，不同特征和稀有度的NFT，所以我们选择批量上传，同时上传的Metadata元数据已经替大家打包好了，可以[下载使用](https://pan.quark.cn/s/76e84633ae36)。注意需要上传的是Json文件，Json文件内包含了NFT的元数据。
